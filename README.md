...
```
cd existing_repo
git remote add origin https://gitlab.com/mayWeMeetAgain11/jawak-wa-tareekak.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mayWeMeetAgain11/jawak-wa-tareekak/-/settings/integrations)
